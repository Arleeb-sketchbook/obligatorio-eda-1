                        ...
                        case 2:
                            if (estacionamiento->tope == -1) {
                                ...
                                if (!estacionamentoIsFull(estacionamiento) && !esta_vacia(&cola)) {
                                    ...
                                    printf("Vehículo de la cola ha ingresado al estacionamiento:\n");
                    ...
                    switch (subopcion) {
                        ...
                        case 3: {
                            ...
                            encolar(&cola, a);
                                ...
                                push(estacionamiento, a);
                                printf("El estacionamiento tiene lugar, Vehículo registrado correctamente en el estacionamiento.\n");
                            }
                        ...
                        case 2: {
                            ...
                            if (a.hora_llegada != -1) {
                                ...
                                a.hora_Salida = hs;
                                a.minutos_Salida = ms;
                                printf("Salida: Matricula: %s, Hora de llegada: %02d:%02d, Hora de salida: %02d:%02d\n",
                                       a.matricula, a.hora_llegada,a.minutos_llegada ,a.hora_Salida, a.minutos_Salida);
                            }
                            } else {
                                printf("La cola está vacía, no hay vehículos para registrar salida.\n");
                            }
